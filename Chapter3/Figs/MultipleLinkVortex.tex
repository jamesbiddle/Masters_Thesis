...
\begin{scope}[very thick,decoration={
  ...
  \draw[line width=1.0,postaction={decorate},color=cyan]( 1.5, 4.0)--node[above,color=black]{$\exp{\left(\pi i \mathcal{Q}\right)}$}(-4.0,4.0);    % height 6.25-1.5    = 4.75
  ...
  \draw[line width=1.0,postaction={decorate},color=cyan](7,4) --node[above,color=black]{$\exp{\left(\pi i \mathcal{Q}\right)}$} (1.5,4);
