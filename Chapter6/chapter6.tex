...
\label{eq:CTprop}
\end{equation}
analogous to the scalar gluon propagator derived in Chapter~\ref{chapter:GluonPropagator}. As can be clearly seen from Fig.~\ref{fig:CrossTerms}, in the ensemble average Eq.~\eqref{eq:CTprop} vanishes, indicating that the vortex only and vortex removed configurations truly do represent a orthogonal degrees of freedom.\\ 
%
\begin{figure}[htb!]
\centering
